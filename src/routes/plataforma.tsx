...
const AGENTES = [
  {
    ...
    descricao: "Veja o futuro do seu caixa antes que ele aconteça.",
    status: "Disponível agora",
  },
  {
    nome: "Agente Fiscal",
    descricao: "Alertas antecipados sobre obrigações e mudanças tributárias.",
    status: "Em construção",
  },
  {
    nome: "Agente de Precificação",
    descricao: "Preço ideal calculado a partir do seu custo real e do mercado.",
    status: "Em construção",
  },
  {
    nome: "Agente de Negociação com Fornecedores",
    descricao: "Melhores condições de pagamento, negociadas com dados.",
    status: "Em construção",
  },
  {
    nome: "Agente de Compliance Trabalhista",
    descricao: "Evite passivos trabalhistas antes que eles aconteçam.",
    status: "Em construção",
  },
];
          ...
          {AGENTES.map((a, i) => (
            ...
            >
              ...
              <span
                className={
                  "text-xs " +
                  (a.status === "Disponível agora" ? "text-positive" : "text-muted-foreground")
                }
              >
                {a.status}
              </span>
